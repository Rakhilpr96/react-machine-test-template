...
const App = () => {
  ...
  return (
    <div>
      <div>
        <div>
          <input type="radio" id="task1" checked={taskItem === "Task1"} onChange={() => setTaskItem("Task1")} />
          <label htmlFor="task1">Task 1</label>
        </div>
        <div>
          <input type="radio" id="task2" checked={taskItem === "Task2"} onChange={() => setTaskItem("Task2")} />
